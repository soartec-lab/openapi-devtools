...
class UsersApi {
  ...
  Future<Response<Users>> getUsers({ 
    int? page,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Created>> users({ 
    required UsersCreateParams usersCreateParams,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UsersCreateParams);
      _bodyData = _serializers.serialize(usersCreateParams, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(Created),
      ) as Created;
